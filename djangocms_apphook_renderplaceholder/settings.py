"""
Django settings for djangocms_apphook_renderplaceholder project.
...
SECRET_KEY = 'django-insecure-jj_!x7x3c*f238ih5^@7-p__6^e$57=o5bq#xxu1-kaauu!382'
...
ROOT_URLCONF = 'djangocms_apphook_renderplaceholder.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, "djangocms_apphook_renderplaceholder", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'djangocms_apphook_renderplaceholder.wsgi.application'
...
STATICFILES_DIRS = [
    BASE_DIR / "djangocms_apphook_renderplaceholder" / "static",
]
